# Building RePosband on Modern macOS

This document describes how to build RePosband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `reposband-terminal` in the parent directory.
...
### Available Targets
- `reposband` - Build executable only
...
After building:
```bash
# From the main RePosband directory:
./reposband-terminal
```
...
- Make sure you're running from the RePosband directory (where lib/ is)
