# File: Makefile.gdb
# By DarkGod, to create a conglomoband.bin to be used with gdb
...
default: ../conglomoband.bin $(TOLUA)

release: ../conglomoband.bin
	upx -9 ../conglomoband.exe
#         copy conglomoband.exe ..
#         del conglomoband.exe

install: ../conglomoband.bin
#        copy conglomoband.exe ..

all: ../conglomoband.bin
