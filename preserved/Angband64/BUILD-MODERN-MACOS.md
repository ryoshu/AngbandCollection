# Building Angband64 on Modern macOS

This document describes how to build Angband64 on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `angband64-terminal` in the parent directory.
...
### Available Targets
- `angband64` - Build executable only
...
After building:
```bash
# From the main Angband64 directory:
./angband64-terminal
```
...
- Make sure you're running from the Angband64 directory (where lib/ is)
