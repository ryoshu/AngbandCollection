# Building Neoband on Modern macOS

This document describes how to build Neoband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `neoband-terminal` in the parent directory.
...
After building:
```bash
# From the main Neoband directory:
./neoband-terminal
```
...
- Make sure you're running from the Neoband directory (where lib/ is)
