# Building Chengband on Modern macOS

This document describes how to build Chengband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `chengband-terminal` in the parent directory.
...
### Available Targets
- `chengband` - Build executable only
...
After building:
```bash
# From the main Chengband directory:
./chengband-terminal
```
...
- Make sure you're running from the Chengband directory (where lib/ is)
