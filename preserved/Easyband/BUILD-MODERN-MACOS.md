# Building Easyband on Modern macOS

This document describes how to build Easyband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `easyband-terminal` in the parent directory.
...
### Available Targets
- `easyband` - Build executable only
...
After building:
```bash
# From the main Easyband directory:
./easyband-terminal
```
...
- Make sure you're running from the Easyband directory (where lib/ is)
