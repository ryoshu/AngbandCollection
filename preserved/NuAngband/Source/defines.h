...
#define HREALM_MAX 7 /* must be a power of 2 because of implementation of mage weapons, 
                      * and possibly other things implemented after this comment was made */
...
#define PY_HSPELL_LEARNED	0x10
#define PY_HSPELL_WORKED		0x20
#define PY_HSPELL_FORGOTTEN	0x40
 ...
 */
#define INVEN_WIELD1	INVEN_PACK+1
#define INVEN_BOW       INVEN_PACK+2
#define INVEN_LEFT      INVEN_PACK+3
#define INVEN_RIGHT     INVEN_PACK+4
#define INVEN_NECK      INVEN_PACK+5
#define INVEN_LITE      INVEN_PACK+6
#define INVEN_BODY      INVEN_PACK+7
#define INVEN_OUTER     INVEN_PACK+8
#define INVEN_WIELD2    INVEN_PACK+9
#define INVEN_HEAD      INVEN_PACK+10
#define INVEN_HANDS     INVEN_PACK+11
#define INVEN_FEET      INVEN_PACK+12
#define INVEN_SHOTS		INVEN_PACK+13

/*
 * Total number of inventory slots (hard-coded).
 */
#define INVEN_TOTAL	INVEN_SHOTS+1
...
#define SV_STEEL_BOW		15
#define SV_LIGHT_XBOW		26	/* (x6) */
#define SV_HEAVY_XBOW		28	/* (x8) */
...
/* The special Mage Weapons */
#define SV_MAGESTAFF_HEAD		70 /* TV_HAFTED */
#define SV_MAGEROD_HEAD			70 /* TV_POLEARM */
#define SV_MAGEBLADE_HEAD		70 /* TV_SWORD */

#define SV_MAGESTAFF_LIGHTDARK	SV_MAGESTAFF_HEAD + 0
#define SV_MAGESTAFF_FIRECOLD	SV_MAGESTAFF_HEAD + 1
#define SV_MAGESTAFF_WATER		SV_MAGESTAFF_HEAD + 2
#define SV_MAGESTAFF_LIFE		SV_MAGESTAFF_HEAD + 3
#define SV_MAGESTAFF_EARTH		SV_MAGESTAFF_HEAD + 4
#define SV_MAGESTAFF_TIMESPACE	SV_MAGESTAFF_HEAD + 5
#define SV_MAGESTAFF_MAGIC		SV_MAGESTAFF_HEAD + 6

#define SV_MAGEROD_LIGHTDARK	SV_MAGEROD_HEAD + 0
#define SV_MAGEROD_FIRECOLD		SV_MAGEROD_HEAD + 1
#define SV_MAGEROD_WATER		SV_MAGEROD_HEAD + 2
#define SV_MAGEROD_LIFE			SV_MAGEROD_HEAD + 3
#define SV_MAGEROD_EARTH		SV_MAGEROD_HEAD + 4
#define SV_MAGEROD_TIMESPACE	SV_MAGEROD_HEAD + 5
#define SV_MAGEROD_MAGIC		SV_MAGEROD_HEAD + 6

#define SV_MAGEBLADE_LIGHTDARK	SV_MAGEBLADE_HEAD + 0
#define SV_MAGEBLADE_FIRECOLD	SV_MAGEBLADE_HEAD + 1
#define SV_MAGEBLADE_WATER		SV_MAGEBLADE_HEAD + 2
#define SV_MAGEBLADE_LIFE		SV_MAGEBLADE_HEAD + 3
#define SV_MAGEBLADE_EARTH		SV_MAGEBLADE_HEAD + 4
#define SV_MAGEBLADE_TIMESPACE	SV_MAGEBLADE_HEAD + 5
#define SV_MAGEBLADE_MAGIC		SV_MAGEBLADE_HEAD + 6
...
#define SV_FOOD_MAGIC			20 /* a little memorial to the "too anoying to keep" magic mushroom patch */
...
#define SM_RES_LAW		0x00000080 /* law resist */
 ...
 * 
 * Note that the new "flags4" contains "obvious flags" like which weapons take 
 * both hands, etc.  It also contains the "mage weapon realm" flags.  
 */
...
#define TR2_RES_LAW         0x00000800L /* (reserved) *//* resist law */
...
#define TR4_PRIMARY			0x00000001L
#define TR4_SECONDARY		0x00000002L
#define TR4_2H				0x00000004L
#define TR4_XBOW			0x00000008L
#define TR4_MAGE			0x00000010L
#define TR4_MAGE_LIGHTDARK	0x00000020L
#define TR4_MAGE_FIRECOLD	0x00000040L
#define TR4_MAGE_WATER		0x00000080L
#define TR4_MAGE_EARTH		0x00000100L
#define TR4_MAGE_LIFE		0x00000200L
#define TR4_MAGE_TIMESPACE	0x00000400L
#define TR4_MAGE_MAGIC		0x00000800L
...
#define TR4_MUNDANE_MASK \
	(TR4_PRIMARY | TR4_SECONDARY | TR4_2H | TR4_XBOW )
...
#define CF_ASSASINATE		0x00000200L /* Allow better assasination against sleeping monsters */
#define CF_HEAVY_CRIT		0x00000400L /* Allow better critical hits */
#define CF_xxx12			0x00000800L
#define CF_HIGH_MAGIC1		0x00001000L /* Permits learning of high spells in 1 realm */
#define CF_HIGH_MAGIC2		0x00002000L /* Permits learning of high spells in 2 realms */
#define CF_HIGH_MAGIC3		0x00004000L /* Permits learning of high spells in 3 realms */
...
/*
 * the 'nonliving monster types mask', and some other masks for the summon_specific
 * function and monster noises(previously hardcoded).
 */

#define MON_NONLIFE  "Xgv"
#define MON_HYDRA "H"
#define MON_ANT "a"
#define MON_MUCKY_NOISE "jmvQ"
#define MON_JELLY "imj,"
#define MON_HOUND "CZ"
#define MON_VOICE "pPkKyhEdDetToO"
#define MON_HIGH_UNDEAD "LVW"
#define MON_RINGWRAITH "W"
#define MON_HIGH_DRAGON "D"
#define MON_HIGH_DEMON "U"
...
#define RF2_HAS_LITE		0x00000004	/* monster lite */
...
#define RF3_RES_ACID		0x00000100	/* resist acid somewhat */
#define RF3_RES_ELEC		0x00000200	/* resist elec somewhat */
#define RF3_RES_FIRE		0x00000400	/* resist fire somewhat */
#define RF3_RES_COLD		0x00000800	/* resist cold somewhat */
...
#define RF4_BR_LAW          0x10000000 /* Breathe Law */
...
#define RF6_S_NONLIFE       0x01000000 /* Summon Angel */
...
#define RF6_INT_MASK \
	(RF6_BLINK |  RF6_TPORT | RF6_TELE_LEVEL | RF6_TELE_AWAY | \
	 ...
	 RF6_S_NONLIFE | RF6_S_DRAGON | RF6_S_UNDEAD | RF6_S_DEMON | \
...
#define RF6_SUMMON_MASK \
	(RF6_S_KIN | RF6_S_MONSTER | RF6_S_MONSTERS | RF6_S_ANIMAL | \
	 RF6_S_SPIDER | RF6_S_HOUND | RF6_S_HYDRA | RF6_S_NONLIFE | \
