# Building EyAngband on Modern macOS

This document describes how to build EyAngband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `eyangband-terminal` in the parent directory.
...
### Available Targets
- `eyangband` - Build executable only
...
After building:
```bash
# From the main EyAngband directory:
./eyangband-terminal
```
...
- Make sure you're running from the EyAngband directory (where lib/ is)
