...
#define FLG_MORE_DICE        6
#define FLG_MORE_BONUS       7
#define FLG_ARTIFACT         8
#define FLG_EGO              9
#define FLG_GOOD            10
...
#define FLG_UNAWARE         16
#define FLG_WANTED          17
#define FLG_UNIQUE          18
#define FLG_WALSTANIAN      19
#define FLG_GARGASTAN       20
#define FLG_BACRUM          21
...
#define FLG_ARMORS          31
#define FLG_MISSILES        32
#define FLG_SHOTS           33
#define FLG_DEVICES         34
#define FLG_LIGHTS          35
#define FLG_JUNKS           36
#define FLG_ARCHER          37
...
#define FLG_NOUN_END        FLG_GUNS


#ifdef JP

static char KEY_ALL[] = "���٤Ƥ�";
static char KEY_UNIDENTIFIED[] = "̤�����";
static char KEY_IDENTIFIED[] = "����Ѥߤ�";
static char KEY_STAR_IDENTIFIED[] = "*����*�Ѥߤ�";
static char KEY_COLLECTING[] = "�������";
static char KEY_BOOSTED[] = "�������ܤΰ㤦";
static char KEY_MORE_THAN[] = "��������";
static char KEY_DICE[] = "�ʾ��";
static char KEY_MORE_BONUS[] = "������";
static char KEY_MORE_BONUS2[] = "�ʾ��";
static char KEY_ARTIFACT[] = "�����ƥ��ե�����";
static char KEY_EGO[] = "����";
static char KEY_GOOD[] = "�����";
static char KEY_NAMELESS[] = "̵�ä�";
static char KEY_AVERAGE[] = "�¤�";
static char KEY_WORTHLESS[] = "̵���ͤ�";
static char KEY_RARE[] = "�쥢��";
static char KEY_COMMON[] = "����դ줿";
static char KEY_UNAWARE[] = "̤Ƚ����";
static char KEY_WANTED[] = "�޶���";
static char KEY_UNIQUE[] = "��ˡ�������󥹥�����";
static char KEY_WALSTANIAN[] = "�����륹���ͤ�";
static char KEY_GARGASTAN[] = "���륬������ͤ�";
static char KEY_BACRUM[] = "�Х����ͤ�";
static char KEY_ZENOBIAN[] = "���Υӥ��ͤ�";
static char KEY_LODIS[] = "�����ǥ����ͤ�";
static char KEY_METAL[] = "��°����";

static char KEY_ITEMS[] = "�����ƥ�";
static char KEY_WEAPONS[] = "���";
static char KEY_ARMORS[] = "�ɶ�";
static char KEY_MISSILES[] = "��";
static char KEY_SHOTS[] = "�ƴ�";
static char KEY_DEVICES[] = "��ˡ�����ƥ�";
static char KEY_LIGHTS[] = "����";
static char KEY_JUNKS[] = "���餯��";
static char KEY_ARCHER[] = "����";
static char KEY_CORPSES[] = "���Τ��";
static char KEY_SPELLBOOKS[] = "��ˡ��";
static char KEY_SHIELDS[] = "��";
static char KEY_LAUNCHERS[] = "�ͷ����";
static char KEY_RINGS[] = "����";
static char KEY_AMULETS[] = "���ߥ��å�";
static char KEY_SUITS[] = "��";
static char KEY_CLOAKS[] = "��������";
static char KEY_HELMS[] = "��";
static char KEY_GLOVES[] = "�Ƽ�";
static char KEY_BOOTS[] = "��";

static char KEY_SMALL_SWORDS[] = "����";
static char KEY_KATANAS[] = "������";
static char KEY_SWORDS[] = "��";
static char KEY_GREAT_SWORDS[] = "���";
static char KEY_AXES[] = "��";
static char KEY_SPEARS[] = "��";
static char KEY_LANCES[] = "������";
static char KEY_CLAWS[] = "��";
static char KEY_SCYTHES[] = "��";
static char KEY_WHIPS[] = "��";
static char KEY_HAMMERS[] = "�ϥ�ޡ�";
static char KEY_STAFFS[] = "��";
static char KEY_FANS[] = "��";
static char KEY_BOWS[] = "��";
static char KEY_GUNS[] = "��";
...
static void autopick_entry_from_object(autopick_type *entry, object_type *o_ptr)
{
	...
	else
	{
		...
		{
			if (object_is_weapon_armour(o_ptr))
			{
				/*
	...
	if (object_is_ammo(o_ptr))
		...
		ADD_FLG(FLG_CORPSES);
	else if (o_ptr->tval >= TV_MAGERY_BOOK)
		...
		ADD_FLG(FLG_AMULETS);
	else if (o_ptr->tval == TV_HARD_ARMOR || o_ptr->tval == TV_SOFT_ARMOR)
		ADD_FLG(FLG_SUITS);
...
void autopick_pickup_items(cave_type *c_ptr)
{
	...
	for (this_o_idx = c_ptr->o_idx; this_o_idx; this_o_idx = next_o_idx)
	{
		...
		auto_inscribe_item(o_ptr, old_idx);
...
static bool clear_auto_register(void)
{
	...
	{
#ifdef JP
		msg_format("�����Υ���饯�����Ѥμ�ư����(%d��)���ĤäƤ��ޤ���", num);
		strcpy(buf, "�Ť�����ԤϺ�����ޤ�����������Ǥ�����");
#else
...
bool autopick_autoregister(object_type *o_ptr)
{
...
#ifdef JP
		if (act & DO_AUTOPICK) what = "��ư�ǽ���";
		else if (act & DO_AUTODESTROY) what = "��ư�˲�����";
		else if (act & DONT_AUTOPICK) what = "���֤���";
		else /* if (act & DO_QUERY_AUTOPICK) */ what = "��ǧ���ƽ���";

		msg_format("���Υ����ƥ�ϴ���%s�褦�����ꤵ��Ƥ��ޤ���", what);
#else
	...
	if (!pref_fff)
	{
		...
		if (!pref_fff)
		{
			...
			path_build(buf, sizeof(buf), ANGBAND_DIR_PREF, pickpref_filename(PT_DEFAULT));
			pref_tmp = my_fopen(buf, "r");

			/* Failed */
			if (pref_tmp)
			{
				/* Copy the contents of default file */
				while (!my_fgets(pref_tmp, buf, sizeof(buf)))
					fprintf(pref_fff, "%s\n", buf);
	...
	if (!pref_fff) {
#ifdef JP
		msg_format("%s �򳫤����Ȥ��Ǥ��ޤ���Ǥ�����", pref_file);
#else
...
static void describe_autopick(char *buff, autopick_type *entry)
{
	...
	{
		before_str[before_n++] = "����դ줿(�ɥ饴����������������������ʪ�ǤϤʤ�)";
		body_str = "����";
	}
	...
	/*** Walstanian monster's statues ***/
	if (IS_FLG(FLG_WALSTANIAN))
	{
		before_str[before_n++] = "�����륹���ͤ�";
		body_str = "��";
	}

	/*** Gargastan monster's statues ***/
	if (IS_FLG(FLG_GARGASTAN))
	{
		before_str[before_n++] = "���륬������ͤ�";
		body_str = "��";
	}

	/*** Bacrum monster's statues ***/
	if (IS_FLG(FLG_BACRUM))
	{
		before_str[before_n++] = "�Х����ͤ�";
		body_str = "��";
	}

	/*** Zenobian monster's statues ***/
	if (IS_FLG(FLG_ZENOBIAN))
	{
		before_str[before_n++] = "���Υӥ��ͤ�";
		body_str = "��";
	}

	/*** Lodis monster's statues ***/
	if (IS_FLG(FLG_LODIS))
	{
		before_str[before_n++] = "�����ǥ����ͤ�";
		body_str = "��";
	}
...
static void prepare_default_pickpref(void)
{
	static char *messages[] = {
		...
		"���ʤ��ϡּ�ư�������ǥ����פ���Ƶ�ư���ޤ�����",
		"��ư�����Υ桼��������ե����뤬�ޤ��񤫤�Ƥ��ʤ��Τǡ�",
		"����Ū�ʼ�ư��������ե������lib/pref/picktype.prf���饳�ԡ����ޤ���",
		NULL
#else
...
#define EC_OK_WALSTANIAN       56
#define EC_OK_GARGASTAN        57
#define EC_OK_BACRUM           58
#define EC_OK_ZENOBIAN         59
#define EC_OK_LODIS            60
#define EC_OK_METAL            61
#define EC_KK_WEAPONS          62
#define EC_KK_ARMORS           63
#define EC_KK_MISSILES         64
#define EC_KK_SHOTS            65
#define EC_KK_DEVICES          66
#define EC_KK_LIGHTS           67
#define EC_KK_JUNKS            68
#define EC_KK_CORPSES          69
#define EC_KK_ARCHER           70
#define EC_KK_SPELLBOOKS       71
#define EC_KK_SHIELDS          72
#define EC_KK_LAUNCHERS        73
#define EC_KK_RINGS            74
#define EC_KK_AMULETS          75
#define EC_KK_SUITS            76
#define EC_KK_CLOAKS           77
#define EC_KK_HELMS            78
#define EC_KK_GLOVES           79
#define EC_KK_BOOTS            80
#define EC_KK_SMALL_SWORDS     81
#define EC_KK_KATANAS          82
#define EC_KK_SWORDS           83
#define EC_KK_GREAT_SWORDS     84
#define EC_KK_AXES             85
#define EC_KK_SPEARS           86
#define EC_KK_LANCES           87
#define EC_KK_CLAWS            88
#define EC_KK_SCYTHES          89
#define EC_KK_WHIPS            90
#define EC_KK_HAMMERS          91
#define EC_KK_STAFFS           92
...
static char MN_QUIT[] = "������̵���ǽ�λ";
static char MN_SAVEQUIT[] = "�����֤��ƽ�λ";
static char MN_REVERT[] = "���Ƥ��ѹ����˴�";
static char MN_HELP[] = "�إ��";

static char MN_MOVE[] = "���������ư";
static char MN_LEFT[] =   "��          (���������)";
static char MN_DOWN[] =   "��          (���������)";
static char MN_UP[] =     "��          (���������)";
static char MN_RIGHT[] =  "��          (���������)";
static char MN_BOL[] =    "�Ԥ���Ƭ";
static char MN_EOL[] =    "�Ԥν�ü";
static char MN_PGUP[] =   "��Υڡ���  (PageUp����)";
static char MN_PGDOWN[] = "���Υڡ���  (PageDown����)";
static char MN_TOP[] =    "1���ܤذ�ư (Home����)";
static char MN_BOTTOM[] = "�ǲ��Ԥذ�ư(End����)";

static char MN_EDIT[] = "�Խ�";
static char MN_CUT[] = "���å�";
static char MN_COPY[] = "���ԡ�";
static char MN_PASTE[] = "�ڡ�����";
static char MN_BLOCK[] = "�����ϰϤλ���";
static char MN_KILL_LINE[] = "�ԤλĤ����";
static char MN_DELETE_CHAR[] = "1ʸ�����";
static char MN_BACKSPACE[] = "�Хå����ڡ���";
static char MN_RETURN[] = "����";

static char MN_SEARCH[] = "����";
static char MN_SEARCH_STR[] = "ʸ����Ǹ���";
static char MN_SEARCH_FORW[] = "�����غƸ���";
static char MN_SEARCH_BACK[] = "�����غƸ���";
static char MN_SEARCH_OBJ[] = "�����ƥ�����򤷤Ƹ���";
static char MN_SEARCH_DESTROYED[] = "��ư�˲����줿�����ƥ�Ǹ���";

static char MN_INSERT[] = "��������";
static char MN_INSERT_OBJECT[] = "���򤷤������ƥ��̾��������";
static char MN_INSERT_DESTROYED[] = "��ư�˲����줿�����ƥ��̾��������";
static char MN_INSERT_BLOCK[] = "���ʬ���֥��å����������";
static char MN_INSERT_MACRO[] = "�ޥ������������";
static char MN_INSERT_KEYMAP[] = "�����ޥå����������";

static char MN_COMMAND_LETTER[] = "����/�˲�/���֤�����";
static char MN_CL_AUTOPICK[] = "�� �� (��ư����)";
static char MN_CL_DESTROY[] = "��!�� (��ư�˲�)";
static char MN_CL_LEAVE[] = "��~�� (����)";
static char MN_CL_QUERY[] = "��;�� (��ǧ���ƽ���)";
static char MN_CL_NO_DISP[] = "��(�� (�ޥåץ��ޥ�ɤ�ɽ�����ʤ�)";

static char MN_ADJECTIVE_GEN[] = "���ƻ�(����)������";
static char MN_RARE[] = "�쥢�� (����)";
static char MN_COMMON[] = "����դ줿 (����)";

static char MN_ADJECTIVE_SPECIAL[] = "���ƻ�(�ü�)������";
static char MN_BOOSTED[] = "�������ܤΰ㤦 (���)";
static char MN_MORE_DICE[] = "�������� # �ʾ�� (���)";
static char MN_MORE_BONUS[] = "������ # �ʾ�� (������)";
static char MN_WANTED[] = "�޶��� (����)";
static char MN_UNIQUE[] = "��ˡ�������󥹥����� (����)";
static char MN_WALSTANIAN[] = "�����륹���ͤ� (��)";
static char MN_GARGASTAN[] = "���륬������ͤ� (��)";
static char MN_BACRUM[] = "�Х����ͤ� (��)";
static char MN_ZENOBIAN[] = "���Υӥ��ͤ� (��)";
static char MN_LODIS[] = "�����ǥ����ͤ� (��)";

static char MN_NOUN[] = "̾�������";
static char MN_NOUN2[] = "̾������� (��勵����)";
...
static char MN_WALSTANIAN[] = "walstanian (nation)";
static char MN_GARGASTAN[] = "gargastan (nation)";
static char MN_BACRUM[] = "bacrum (nation)";
static char MN_ZENOBIAN[] = "zenobian (nation)";
static char MN_LODIS[] = "lodis (nation)";

static char MN_NOUN[] = "Keywords (noun)";
static char MN_NOUN2[] = "Keywords (noun, secondary)";
...
command_menu_type menu_data[] =
{
	...
	{KEY_BOOTS, 1, -1, EC_KK_BOOTS},
 	...
 	{MN_NOUN2, 0, -1, -1},
	{KEY_SMALL_SWORDS, 1, -1, EC_KK_SMALL_SWORDS},
	{KEY_KATANAS, 1, -1, EC_KK_KATANAS},
	{KEY_SWORDS, 1, -1, EC_KK_SWORDS},
	{KEY_GREAT_SWORDS, 1, -1, EC_KK_GREAT_SWORDS},
	{KEY_AXES, 1, -1, EC_KK_AXES},
	{KEY_SPEARS, 1, -1, EC_KK_SPEARS},
	{KEY_LANCES, 1, -1, EC_KK_LANCES},
	{KEY_CLAWS, 1, -1, EC_KK_CLAWS},
	{KEY_SCYTHES, 1, -1, EC_KK_SCYTHES},
	{KEY_WHIPS, 1, -1, EC_KK_WHIPS},
	{KEY_HAMMERS, 1, -1, EC_KK_HAMMERS},
	{KEY_STAFFS, 1, -1, EC_KK_STAFFS},
	{KEY_FANS, 1, -1, EC_KK_FANS},
...
#ifdef JP
		prt(format("(a-%c) ���ޥ��:", menu_key + 'a' - 1), 0, 0);
#else
...
static void draw_text_editor(text_body_type *tb)
{
	...
	if (tb->old_cy != tb->cy || (tb->dirty_flags & (DIRTY_ALL | DIRTY_NOT_FOUND | DIRTY_NO_SEARCH)) || tb->dirty_line == tb->cy)
	{
		...
		{
#ifdef JP
			str1 = format("�ѥ����󤬸��Ĥ���ޤ���: %s", tb->search_str);
#else
		...
		{
#ifdef JP
			str1 = format("̵�����֤ιԤ򥹥��åפ��ޤ�����(%s�򸡺���)", tb->search_str);
#else
		...
		{
#ifdef JP
			str1 = format("̵�����֤ιԤ��������դ���ޤ�����(%s�򸡺���)", tb->search_str);
#else
...
static bool do_editor_command(text_body_type *tb, int com_id)
{
	...
	case EC_QUIT:
		...
		{
#ifdef JP
			if (!get_check("���Ƥ��ѹ����˴����Ƥ��齪λ���ޤ�����������Ǥ����� ")) break;
#else
	...
	case EC_REVERT:
		/* Revert to original */
#ifdef JP
		if (!get_check("���Ƥ��ѹ����˴����Ƹ��ξ��֤��ᤷ�ޤ�����������Ǥ����� ")) break;
#else
	...
	case EC_INSERT_BLOCK:
	{
		...
		sprintf(expression, "?:[AND [EQU $RACE %s] [EQU $CLASS %s] [GEQ $LEVEL %02ld]]", 
#ifdef JP
			p_name + rp_ptr->E_name, c_name + cp_ptr->E_name,
#else
			p_name + rp_ptr->name, c_name + cp_ptr->name,
#endif
			p_ptr->lev
			);
	...
	case EC_INSERT_MACRO:
		...
		/* Prompt */
#ifdef JP
		Term_putstr(0, tb->cy - tb->upper + 1, tb->wid - 1, TERM_YELLOW, "P:<�ȥꥬ������>: ");
#else
	...
	case EC_INSERT_KEYMAP:
		...
		/* Prompt */
#ifdef JP
		Term_putstr(0, tb->cy - tb->upper + 1, tb->wid - 1, TERM_YELLOW, format("C:%d:<���ޥ�ɥ���>: ", (rogue_like_commands ? KEYMAP_MODE_ROGUE : KEYMAP_MODE_ORIG)));
#else
	...
	case EC_KK_SHOTS: toggle_keyword(tb, FLG_SHOTS); break;
	...
	case EC_KK_SMALL_SWORDS: toggle_keyword(tb, FLG_SMALL_SWORDS); break;
	case EC_KK_KATANAS: toggle_keyword(tb, FLG_KATANAS); break;
	case EC_KK_SWORDS: toggle_keyword(tb, FLG_SWORDS); break;
	case EC_KK_GREAT_SWORDS: toggle_keyword(tb, FLG_GREAT_SWORDS); break;
	case EC_KK_AXES: toggle_keyword(tb, FLG_AXES); break;
	case EC_KK_SPEARS: toggle_keyword(tb, FLG_SPEARS); break;
	case EC_KK_LANCES: toggle_keyword(tb, FLG_LANCES); break;
	case EC_KK_CLAWS: toggle_keyword(tb, FLG_CLAWS); break;
	case EC_KK_SCYTHES: toggle_keyword(tb, FLG_SCYTHES); break;
	case EC_KK_WHIPS: toggle_keyword(tb, FLG_WHIPS); break;
	case EC_KK_HAMMERS: toggle_keyword(tb, FLG_HAMMERS); break;
	case EC_KK_STAFFS: toggle_keyword(tb, FLG_STAFFS); break;
	case EC_KK_FANS: toggle_keyword(tb, FLG_FANS); break;
	...
	case EC_OK_WALSTANIAN: toggle_keyword(tb, FLG_WALSTANIAN); break;
	case EC_OK_GARGASTAN: toggle_keyword(tb, FLG_GARGASTAN); break;
	case EC_OK_BACRUM: toggle_keyword(tb, FLG_BACRUM); break;
	case EC_OK_ZENOBIAN: toggle_keyword(tb, FLG_ZENOBIAN); break;
	case EC_OK_LODIS: toggle_keyword(tb, FLG_LODIS); break;
	case EC_OK_METAL: toggle_keyword(tb, FLG_METAL); break;
	}
