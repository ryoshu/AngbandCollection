# Building TOband on Modern macOS

This document describes how to build TOband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `toband-terminal` in the parent directory.
...
After building:
```bash
# From the main TOband directory:
./toband-terminal
```
...
- Make sure you're running from the TOband directory (where lib/ is)
