# Building XBand on Modern macOS

This document describes how to build XBand on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `xband-terminal` in the parent directory.
...
- Make sure you're running from the XBand directory (where lib/ is)
