# Building GSNband on Modern macOS

This document describes how to build GSNband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `gsnband-terminal` in the parent directory.
...
After building:
```bash
# From the main GSNband directory:
./gsnband-terminal
```
...
- Make sure you're running from the GSNband directory (where lib/ is)
