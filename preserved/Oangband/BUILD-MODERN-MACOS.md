...
This document describes how to build Oangband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
- Make sure you're running from the Oangband directory (where lib/ is)
