# Building Minimal on Modern macOS

This document describes how to build Minimal on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `minimal-terminal` in the parent directory.
...
After building:
```bash
# From the main Minimal directory:
./minimal-terminal
```
...
- Make sure you're running from the Minimal directory (where lib/ is)
