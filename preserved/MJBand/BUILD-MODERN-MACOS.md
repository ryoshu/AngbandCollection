# Building MJBand on Modern macOS

This document describes how to build MJBand on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `mjband-terminal` in the parent directory.
...
After building:
```bash
# From the main MJBand directory:
./mjband-terminal
```
...
- Make sure you're running from the MJBand directory (where lib/ is)
