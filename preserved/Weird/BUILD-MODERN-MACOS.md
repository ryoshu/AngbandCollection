# Building Weird on Modern macOS

This document describes how to build Weird on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `weird-terminal` in the parent directory.
...
- Make sure you're running from the Weird directory (where lib/ is)
