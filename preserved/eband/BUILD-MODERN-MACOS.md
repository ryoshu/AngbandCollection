# Building eband on Modern macOS

This document describes how to build eband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `eband-terminal` in the parent directory.
...
- Make sure you're running from the eband directory (where lib/ is)
