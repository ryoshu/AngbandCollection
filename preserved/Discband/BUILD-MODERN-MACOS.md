# Building Discband on Modern macOS

This document describes how to build Discband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `discband-terminal` in the parent directory.
...
### Available Targets
- `discband` - Build executable only
...
After building:
```bash
# From the main Discband directory:
./discband-terminal
```
...
- Make sure you're running from the Discband directory (where lib/ is)
