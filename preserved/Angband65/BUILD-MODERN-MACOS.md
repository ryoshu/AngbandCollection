# Building Angband65 on Modern macOS

This document describes how to build Angband65 on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `angband65-terminal` in the parent directory.
...
### Available Targets
- `angband65` - Build executable only
...
After building:
```bash
# From the main Angband65 directory:
./angband65-terminal
```
...
- Make sure you're running from the Angband65 directory (where lib/ is)
