# Building Xygos on Modern macOS

This document describes how to build Xygos on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `xygos-terminal` in the parent directory.
...
- Make sure you're running from the Xygos directory (where lib/ is)
