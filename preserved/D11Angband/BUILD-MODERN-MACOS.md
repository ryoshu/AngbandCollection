# Building D11Angband on Modern macOS

This document describes how to build D11Angband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `d11angband-terminal` in the parent directory.
...
### Available Targets
- `d11angband` - Build executable only
...
After building:
```bash
# From the main D11Angband directory:
./d11angband-terminal
```
...
- Make sure you're running from the D11Angband directory (where lib/ is)
