# Building Sil on Modern macOS

This document describes how to build Sil on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `sil-terminal` in the parent directory.
...
- Make sure you're running from the Sil directory (where lib/ is)
