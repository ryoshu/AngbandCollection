# Building PziAngband on Modern macOS

This document describes how to build PziAngband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `pziangband-terminal` in the parent directory.
...
### Available Targets
- `pziangband` - Build executable only
...
After building:
```bash
# From the main PziAngband directory:
./pziangband-terminal
```
...
- Make sure you're running from the PziAngband directory (where lib/ is)
