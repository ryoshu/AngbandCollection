# Building Kamband on Modern macOS

This document describes how to build Kamband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `kamband-terminal` in the parent directory.
...
After building:
```bash
# From the main Kamband directory:
./kamband-terminal
```
...
- Make sure you're running from the Kamband directory (where lib/ is)
