# Building TFork on Modern macOS

This document describes how to build TFork on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `tfork-terminal` in the parent directory.
...
- Make sure you're running from the TFork directory (where lib/ is)
