# Building Craftband on Modern macOS

This document describes how to build Craftband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `craftband-terminal` in the parent directory.
...
### Available Targets
- `craftband` - Build executable only
...
After building:
```bash
# From the main Craftband directory:
./craftband-terminal
```
...
- Make sure you're running from the Craftband directory (where lib/ is)
