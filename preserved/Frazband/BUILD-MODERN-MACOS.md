# Building Frazband on Modern macOS

This document describes how to build Frazband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `frazband-terminal` in the parent directory.
...
### Available Targets
- `frazband` - Build executable only
...
After building:
```bash
# From the main Frazband directory:
./frazband-terminal
```
...
- Make sure you're running from the Frazband directory (where lib/ is)
