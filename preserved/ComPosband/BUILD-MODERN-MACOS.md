...
This document describes how to build ComPosband on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `composband-terminal` in the parent directory.
...
After building:
```bash
# From the main ComPosband directory:
./composband-terminal
```
...
- Make sure you're running from the ComPosband directory (where lib/ is)
