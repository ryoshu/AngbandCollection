# Building RandomBand on Modern macOS

This document describes how to build RandomBand on modern macOS systems (macOS 10.15+, including Apple Silicon Macs).
...
This creates `randomband-terminal` in the parent directory.
...
### Available Targets
- `randomband` - Build executable only
...
After building:
```bash
# From the main RandomBand directory:
./randomband-terminal
```
...
- Make sure you're running from the RandomBand directory (where lib/ is)
